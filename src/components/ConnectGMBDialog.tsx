...
export const ConnectGMBDialog = ({ open, onOpenChange }: ConnectGMBDialogProps) => {
  ...
  const handleConnectGoogle = async () => {
    await initiateOAuth();
    // Don't close the dialog - the OAuth flow opens in a new window
    // The user will return to the app after completing OAuth
  };
        ...
        <div className="space-y-4 mt-4">
          <div className="bg-muted/50 rounded-lg p-4 space-y-2">
            <p className="text-sm text-muted-foreground">
              This connection allows GoogleReviewAI to:
            </p>
