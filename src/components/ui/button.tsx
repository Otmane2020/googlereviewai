  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-semibold ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        google: "bg-card text-foreground border border-border hover:bg-muted shadow-lg hover:shadow-xl hover:-translate-y-0.5 font-medium",
        hero: "bg-card text-primary border-0 shadow-xl hover:shadow-2xl hover:-translate-y-1 font-semibold",
        heroOutline: "bg-transparent text-card border-2 border-card/30 hover:bg-card/10 hover:border-card/50 font-medium",
      },
      size: {
