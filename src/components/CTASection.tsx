  ...
  return (
    <section className="py-16 sm:py-20 md:py-24 gradient-hero relative overflow-hidden">
      ...
      <div className="relative container mx-auto px-5 sm:px-6 text-center">
        <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-card mb-4 sm:mb-6 px-2 flex flex-wrap items-center justify-center gap-2">
          Prêt à automatiser vos réponses <GoogleIcon className="w-8 h-8 sm:w-10 sm:h-10" /> ?
        </h2>
